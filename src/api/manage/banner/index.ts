...
import Api from '@/core/permission/modules/banner';

export function getBannerListPage(data: API.PageParams<{ departmentIds: number[] }>) {
...
export function deleteBanners(data: { ids: number[] }) {
  return request({
    url: Api.delete,
    method: 'post',
    data,
